...
<Project Type="Project" LVVersion="18008000">
	<Item Name="z" Type="Target Folder"/>
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="抽奖程序.vi" Type="VI" URL="../抽奖程序.vi"/>
		<Item Name="创建数组.vi" Type="VI" URL="../创建数组.vi"/>
		<Item Name="簇波形图.vi" Type="VI" URL="../簇波形图.vi"/>
		<Item Name="簇函数.vi" Type="VI" URL="../簇函数.vi"/>
		<Item Name="簇函数应用.vi" Type="VI" URL="../簇函数应用.vi"/>
		<Item Name="录音.vi" Type="VI" URL="../录音.vi"/>
		<Item Name="录音播放.vi" Type="VI" URL="../录音播放.vi"/>
		<Item Name="数组波形.vi" Type="VI" URL="../数组波形.vi"/>
